...
print('c = circle mode, s + q = square mode, c = christmas mode, n + c = not christmas mode, while hold equale key rainbow mode = True, if speed 9 pattern apears')
...
while run:
    ...
    if keys[pig.K_s] and keys[pig.K_F1] and win_color == black:
        color = black
        num += 1
        pig.image.save(win, path)
        pig.image.save(win, (p_a_p + r'paint app gus v5\data/saves/{num}.png'))
        subprocess.Popen('explorer "C:/desktop"')
        subprocess.CREATE_NEW_CONSOLE
        
    if keys[pig.K_s] and keys[pig.K_F1] and win_color == white:
        color = black
        num += 1
        pig.image.save(win, path)
        pig.image.save(win, (p_a_p + r'paint app gus v5\data/saves/{num}.png'))
    ...
    if keys[pig.K_s] and keys[pig.K_F2] and win_color == black:
        color = black
        pig.image.save(win, path)
    ...
    if keys[pig.K_s] and keys[pig.K_F3] and win_color == black:
        color = black
        pig.image.save(win, path)
    ...
    if keys[pig.K_s] and keys[pig.K_F4] and win_color == black:
        color = black
        pig.image.save(win, path)
    ...
    if keys[pig.K_s] and keys[pig.K_F5] and win_color == black:
        color = black
        pig.image.save(win, path)
    ...
    if keys[pig.K_s] and keys[pig.K_F6] and win_color == black:
        color = black
        pig.image.save(win, path)
    ...
    if keys[pig.K_s] and keys[pig.K_F7] and win_color == black:
        color = black
        pig.image.save(win, path)
    ...
    if keys[pig.K_s] and keys[pig.K_F8] and win_color == black:
        color = black
        pig.image.save(win, path)
    ...
    if keys[pig.K_s] and keys[pig.K_F9] and win_color == black:
        color = black
        pig.image.save(win, path)
    ...
    if keys[pig.K_s] and keys[pig.K_END and win_color == black]:
        color = black
        pig.image.save(win, path)
